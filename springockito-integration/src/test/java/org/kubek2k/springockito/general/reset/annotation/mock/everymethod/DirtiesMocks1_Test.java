package org.kubek2k.springockito.general.reset.annotation.mock.everymethod;
...
@ContextConfiguration(loader = SpringockitoContextLoader.class, locations = {"classpath:spring/general/reset/annotation/mock/everymethod/context.xml"})
...
public class DirtiesMocks1_Test extends AbstractJUnit4SpringockitoContextTests {
    ...
    @Ordered(2)
    @Test
    public void verifyBehaviourWasResetAndRecodredNewBehaviour() {
        String returnedString = firstBean.returnString("ala123");
