package org.kubek2k.springockito.general.reset.annotation.spy.afterclass;
...
@ContextConfiguration(loader = SpringockitoContextLoader.class, locations = {"classpath:spring/general/reset/annotation/spy/afterclass/context.xml"})
